...
//	public ArrayList<employeInfo> list(){
//		return (ArrayList<employeInfo>) add_In_List;
//	}
//	
	public static void main(String[] args) {
		Information_From info = new Information_From();
		info.Info(0,null) ;

	}
	
	public void Info(int n,String user){
		this.user1 = user;
